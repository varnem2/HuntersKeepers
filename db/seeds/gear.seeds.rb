...
[
  ...
  { name: '.38 Revolver', harm: 2, tags: 'close, reload, loud', description: 'normal' },
  { name: '9mm', harm: 2, tags: 'close, loud', description: 'normal' },
  { name: 'Assault Rifle', harm: 3, tags: 'far, area, loud, reload', description: 'serious' },
  ...
  { name: 'Big Knife', harm: 1, tags: 'hand', description: 'normal' },
  ...
  { name: 'Grenade Launcher', harm: 4, tags: 'far, area, messy, loud, reload', description: 'serious' },
  { name: 'Grenades', harm: 4, tags: 'close, area, messy, loud', description: 'serious' },
  ...
  { name: 'Hunting Rifle', harm: 2, tags: 'far, loud', description: 'normal' },
  ...
  { name: 'Shotgun', harm: 3, tags: 'close, messy', description: 'normal' },
  ...
  { name: 'Sniper Rifle', harm: 3, tags: 'far', description: 'serious' },
  ...
  { name: 'Submachine Gun', harm: 3, tags: 'close, area, loud, reload', description: 'serious' },
